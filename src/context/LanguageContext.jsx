...
CONTACT_ERROR_NAME_FORMAT: "Please enter a real name (letters only)",
CONTACT_ERROR_EMAIL_REQUIRED: "Please enter email",
CONTACT_ERROR_EMAIL_FORMAT: "Invalid email format",
CONTACT_ERROR_PHONE_FORMAT: "Invalid phone format",
CONTACT_ERROR_MESSAGE_REQUIRED: "Please enter a message",
CONTACT_ERROR_MESSAGE_LENGTH: "Message must be at least 10 characters",
...
CONTACT_ERROR_NAME_FORMAT: "Wprowadź prawdziwe imię (tylko litery)",
CONTACT_ERROR_EMAIL_REQUIRED: "Wprowadź email",
CONTACT_ERROR_EMAIL_FORMAT: "Nieprawidłowy format email",
CONTACT_ERROR_PHONE_FORMAT: "Nieprawidłowy format telefonu",
CONTACT_ERROR_MESSAGE_REQUIRED: "Wprowadź wiadomość",
CONTACT_ERROR_MESSAGE_LENGTH: "Wiadomość musi mieć co najmniej 10 znaków",
...
CONTACT_ERROR_NAME_REQUIRED: "Введіть імʼя",
CONTACT_ERROR_NAME_FORMAT: "Введіть справжнє імʼя (тільки літери)",
CONTACT_ERROR_EMAIL_REQUIRED: "Введіть email",
CONTACT_ERROR_EMAIL_FORMAT: "Невірний формат email",
CONTACT_ERROR_PHONE_FORMAT: "Невірний формат телефону",
CONTACT_ERROR_MESSAGE_REQUIRED: "Введіть повідомлення",
CONTACT_ERROR_MESSAGE_LENGTH: "Повідомлення має містити мінімум 10 символів",
...
CONTACT_SEND: "送信",
CONTACT_SENDING: "送信中...",
CONTACT_ERROR_NAME_REQUIRED: "お名前を入力してください",
CONTACT_ERROR_NAME_FORMAT: "本名を入力してください（文字のみ）",
CONTACT_ERROR_EMAIL_REQUIRED: "メールアドレスを入力してください",
CONTACT_ERROR_EMAIL_FORMAT: "無効なメール形式",
CONTACT_ERROR_PHONE_FORMAT: "無効な電話番号形式",
CONTACT_ERROR_MESSAGE_REQUIRED: "メッセージを入力してください",
CONTACT_ERROR_MESSAGE_LENGTH: "メッセージは10文字以上で入力してください",
